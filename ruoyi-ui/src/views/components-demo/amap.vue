<template>
  <div class="app-container">
    <el-divider content-position="left">
      基于
      <a class="link-type" href="https://github.com/ElemeFE/vue-amap"
        >el-amap</a
      >
      高德地图
    </el-divider>
    ...
    $Geocoder(options) {
      ...
      if (AMap) {
        AMap.plugin(["AMap.Geocoder"], () => {
          ...
          var lnglatXY = options.lnglatXY || [116.397726, 39.903767]; //已知点坐标
